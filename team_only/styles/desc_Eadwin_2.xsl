...
<!-- added the p for Eadwin Psalter-->
	<xsl:template match="tei:msItem/tei:p[node()]">
	    
	--------------      <xsl:apply-templates/>
	</xsl:template>
	
	
	<xsl:template match="tei:msItem/tei:p/tei:rubric[@type='initial']">
	    <p>
	      <span class="itemHeading">Rubric</span> (intial): 
	    	<xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:rubric/tei:locus[node()]">
			<span class="small">(<xsl:apply-templates/>) </span>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:incipit[node()][@xml:lang='en']">
	    <p>
	      <span class="itemHeading">Incipit</span>: 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	 <xsl:template match="tei:msItem/tei:p/tei:incipit[node()][@xml:lang='lt']">
	    <p>
	      <span class="itemHeading">Incipit</span> (Latin): 
	      <xsl:apply-templates/>
	    </p>
	 </xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:incipit[node()][@xml:lang='fr']">
	    <p>
	      <span class="itemHeading">Incipit</span> (French): 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:incipit/tei:locus[node()]">
			<span class="small">(<xsl:apply-templates/>) </span>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:explicit[node()][@xml:lang='en']">
	    <p>
	      <span class="itemHeading">Explicit</span>: 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:explicit[node()][@xml:lang='lt']">
	    <p>
	      <span class="itemHeading">Explicit</span> (Latin): 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:explicit[node()][@xml:lang='fr']">
	    <p>
	      <span class="itemHeading">Explicit</span> (French): 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:explicit/tei:locus[node()]">
			<span class="small">(<xsl:apply-templates/>) </span>
	</xsl:template>
	
		<xsl:template match="tei:msItem/tei:p/tei:rubric[@type='final'][node()]">
	    <p>
	...
	<xsl:template match="tei:msItem/tei:p/tei:colophon[node()][@xml:lang='en']">
	<p>
	      <span class="itemHeading">Colophon</span>: 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:colophon[node()][@xml:lang='lt']">
	    <p>
	      <span class="itemHeading">Colophon</span> (Latin): 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:colophon[node()][@xml:lang='fr']">
	    <p>
	      <span class="itemHeading">Colophon</span> (French): 
	      <xsl:apply-templates/>
	    </p>
	</xsl:template>
	<xsl:template match="tei:msItem/tei:p/tei:colophon/tei:locus[node()]">
			<span class="small">(<xsl:apply-templates/>) </span>
	</xsl:template>
